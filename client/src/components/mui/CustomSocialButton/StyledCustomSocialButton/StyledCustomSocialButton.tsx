...
import { StyledCustomSocialButtonProps } from "./StyledCustomSocialButton.models";

const StyledCustomSocialButton = styled(
  Button,
  transientOptions
)(({ theme, $ownerState }: StyledCustomSocialButtonProps) => {
