...
import { StyledCustomButtonProps } from "./StyledCustomButton.models";

const StyledCustomButton = styled(
  Button,
  transientOptions
)(({ theme, $ownerState }: StyledCustomButtonProps) => {
  const { palette, functions, borders, boxShadows } = theme;
  const { color, variant, size, circular, iconOnly, isDarkMode } = $ownerState;
