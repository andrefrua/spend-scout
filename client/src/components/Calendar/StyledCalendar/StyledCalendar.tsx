...
import { StyledCalendarProps } from "./StyledCalendar.models";

export default styled(
  Box,
  transientOptions
)(({ theme, $ownerState }: StyledCalendarProps) => {
  ...
  return {
    ...
    "& .fc .fc-col-header-cell-cushion": {
      ...
      color: isDarkMode ? white.main : grey[500]
    },

    "& .fc .fc-daygrid-day-number": {
      color: isDarkMode ? white.main : grey[700],
      fontSize: size.sm,
